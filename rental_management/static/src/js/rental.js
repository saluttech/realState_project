    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            if (propertyData) {
                ...
                this.state.tenancyTopBroker = { 'x-axis': propertyData['tenancy_top_broker'][0], 'y-axis': propertyData['tenancy_top_broker'][1] }
                this.state.soldTopBroker = { 'x-axis': propertyData['tenancy_top_broker'][2], 'y-axis': propertyData['tenancy_top_broker'][3] }
                this.state.tenancyDuePaid = { 'x-axis': propertyData['due_paid_amount'][2], 'y-axis': propertyData['due_paid_amount'][3] }
